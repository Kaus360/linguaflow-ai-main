...
LOCAL_RULES: dict[str, list[Rule]] = {
    ...
    "hi-IN": [
        ...
        (r"मैं ([^।.!?]+) जाता है", r"मैं \1 जाता हूँ"),
        (r"मैं ([^।.!?]+) जाती है", r"मैं \1 जाती हूँ"),
        (r"मैं कल ([^।.!?]+) गया है", r"मैं कल \1 गया था"),
        (r"मैं कल ([^।.!?]+) गई है", r"मैं कल \1 गई थी"),
        (r"मैं ([^।.!?]+) गया है", r"मैं \1 गया था"),
        (r"मैं ([^।.!?]+) गई है", r"मैं \1 गई थी"),
        (r"वह जाता हूँ", "वह जाता है"),
        (r"वह जाती हूँ", "वह जाती है"),
        (r"वे जाता है", "वे जाते हैं"),
        (r"हम जाता है", "हम जाते हैं"),
    ...
    "mr-IN": [
        ...
        (r"मी ([^।.!?]+) जातो आहे", r"मी \1 जात आहे"),
        (r"मी ([^।.!?]+) जाते आहे", r"मी \1 जात आहे"),
        (r"मी काल ([^।.!?]+) जातो", r"मी काल \1 गेलो"),
        (r"मी काल ([^।.!?]+) जाते", r"मी काल \1 गेले"),
        (r"मी काल ([^।.!?]+) गेलो आहे", r"मी काल \1 गेलो"),
        (r"मी काल ([^।.!?]+) गेले आहे", r"मी काल \1 गेले"),
        (r"तो जात आहे", "तो जातो आहे"),
        (r"ती जात आहे", "ती जाते आहे"),
        (r"आम्ही जातो आहे", "आम्ही जात आहोत"),
        (r"त्याने जेवण केले आहे", "त्याने जेवण केले"),
        (r"मी काल पार्कला जातो", "मी काल पार्कला गेलो"),
    ],
    "bn-IN": [
        (r"আমি যাচ্ছি হয়", "আমি যাচ্ছি"),
        (r"আমি ([^।.!?]+) যাচ্ছি হয়", r"আমি \1 যাচ্ছি"),
        (r"আমি গতকাল ([^।.!?]+) যাই", r"আমি গতকাল \1 গিয়েছিলাম"),
        (r"আমি কাল ([^।.!?]+) যাই", r"আমি কাল \1 গিয়েছিলাম"),
        (r"আমি ([^।.!?]+) গিয়েছে", r"আমি \1 গিয়েছিলাম"),
        (r"সে খাবার খেয়েছে করি", "সে খাবার খেয়েছে"),
        (r"সে ([^।.!?]+) করি", r"সে \1 করে"),
        (r"তারা যায় হয়", "তারা যায়"),
        (r"আমি গতকাল পার্কে যাই", "আমি গতকাল পার্কে গিয়েছিলাম"),
    ],
    "pa-IN": [
        (r"ਮੈਂ ਜਾਂਦਾ ਹੈ", "ਮੈਂ ਜਾਂਦਾ ਹਾਂ"),
        (r"ਮੈਂ ਜਾਂਦੀ ਹੈ", "ਮੈਂ ਜਾਂਦੀ ਹਾਂ"),
        (r"ਮੈਂ ([^।.!?]+) ਜਾਂਦਾ ਹੈ", r"ਮੈਂ \1 ਜਾਂਦਾ ਹਾਂ"),
        (r"ਮੈਂ ([^।.!?]+) ਜਾਂਦੀ ਹੈ", r"ਮੈਂ \1 ਜਾਂਦੀ ਹਾਂ"),
        (r"ਮੈਂ ਕੱਲ੍ਹ ([^।.!?]+) ਜਾਂਦਾ", r"ਮੈਂ ਕੱਲ੍ਹ \1 ਗਿਆ"),
        (r"ਮੈਂ ਕੱਲ੍ਹ ([^।.!?]+) ਜਾਂਦੀ", r"ਮੈਂ ਕੱਲ੍ਹ \1 ਗਈ"),
        (r"ਮੈਂ ਕੱਲ੍ਹ ([^।.!?]+) ਗਿਆ ਹੈ", r"ਮੈਂ ਕੱਲ੍ਹ \1 ਗਿਆ ਸੀ"),
        (r"ਮੈਂ ਕੱਲ੍ਹ ([^।.!?]+) ਗਈ ਹੈ", r"ਮੈਂ ਕੱਲ੍ਹ \1 ਗਈ ਸੀ"),
        (r"ਉਹ ਜਾਂਦਾ ਹਾਂ", "ਉਹ ਜਾਂਦਾ ਹੈ"),
        (r"ਉਹ ਜਾਂਦੀ ਹਾਂ", "ਉਹ ਜਾਂਦੀ ਹੈ"),
        (r"ਅਸੀਂ ਜਾਂਦਾ ਹੈ", "ਅਸੀਂ ਜਾਂਦੇ ਹਾਂ"),
